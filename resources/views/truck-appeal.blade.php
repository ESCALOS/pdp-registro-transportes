...
<head>
    ...
    <title>Actualizar Documentos - {{ $truck->license_plate }}</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="container">
        <div class="header">
            <h1>Actualizar Documentos del Vehículo</h1>
        ...
        <div class="content">
            ...
            <div class="truck-info">
                <p><strong>Placa:</strong> {{ $truck->license_plate }}</p>
                <p><strong>Empresa:</strong> {{ $truck->company->business_name }}</p>
                <p><strong>Nacionalidad:</strong> {{ $truck->nationality }}</p>
                <p><strong>Tipo de Camión:</strong> {{ $truck->truck_type }}</p>
            </div>
            ...
            <form action="{{ route('truck.appeal.update', $token) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
